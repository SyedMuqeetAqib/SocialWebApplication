        ...
        <div style={{width: 275}}>
          <div className="overflow-y-auto fixed h-screen pr-3" style={{width: 275}}>
            ...
            <nav className="mt-5 px-2">
              ...
              <a href="#" className="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-800 hover:text-blue-300">
                <svg className="mr-4 h-6 w-6" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} stroke="currentColor" viewBox="0 0 24 24">
          ...
          <section className="w-3/5 border border-y-0 border-gray-800" style={{maxWidth: 600}}>
            ...
            <div>
              <div className="flex justify-start">
                ...
                <div className="mx-2">
                  <h2 className="mb-0 text-xl font-bold text-white">ℜ𝔦𝔠𝔞𝔯𝔡𝔬ℜ𝔦𝔟𝔢𝔦𝔯𝔬.dev</h2>
            ...
            {/* User card*/}
            <div>
              <div className="w-full bg-cover bg-no-repeat bg-center" style={{height: 200, backgroundImage: 'url(https://pbs.twimg.com/profile_banners/2161323234/1585151401/600x200)'}}>
              ...
              <div className="p-4">
                ...
                <div className="space-y-1 justify-center w-full mt-3 ml-3">
                  {/* User basic*/}
                  <div>
                    <h2 className="text-xl leading-6 font-bold text-white">ℜ𝔦𝔠𝔞𝔯𝔡𝔬ℜ𝔦𝔟𝔢𝔦𝔯𝔬.dev</h2>
                ...
                <article className="hover:bg-gray-800 transition duration-350 ease-in-out">
                  ...
                  <div className="pl-16">
                    ...
                    <div className="md:flex-shrink pr-6 pt-3">
                      <div className="bg-cover bg-no-repeat bg-center rounded-lg w-full h-64" style={{height: 200, backgroundImage: 'url(https://images.unsplash.com/photo-1556740738-b6a63e27c4df?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=448&q=80)'}}>
                ...
                <div className="max-w-sm rounded-lg bg-dim-700 overflow-hidden shadow-lg m-4">
                  <div className="flex mb-1">
                    ...
                    <a href="https://www.instagram.com/ricardoribeiro.rr/" target="#" className="flex-col w-full mr-1">
                      <div className="w-full bg-cover bg-no-repeat bg-center" style={{height: 100, backgroundImage: 'url(https://instagram.flis9-1.fna.fbcdn.net/v/t51.2885-15/sh0.08/e35/s640x640/116865832_615803592697921_5045643941059143720_n.jpg?_nc_ht=instagram.flis9-1.fna.fbcdn.net&_nc_cat=101&_nc_ohc=EQFsJZNRIPMAX-pb8EZ&tp=1&oh=1ffba368dc5827c172420060b811d1c4&oe=60433210)'}}>
                    ...
                    <a href="https://www.instagram.com/ricardoribeiro.rr/" target="#" className="flex-col w-full mr-1">
                      <div className="w-full bg-cover bg-no-repeat bg-center" style={{height: 100, backgroundImage: 'url(https://instagram.flis9-1.fna.fbcdn.net/v/t51.2885-15/e35/33476414_2111389325772141_4942435591556956160_n.jpg?_nc_ht=instagram.flis9-1.fna.fbcdn.net&_nc_cat=109&_nc_ohc=m4fof_6edMQAX8y6Mma&tp=1&oh=66d43f3c9ef1e6d35aa27b5ea79fc566&oe=6045E945)'}}>
                    ...
                    <a href="https://www.instagram.com/ricardoribeiro.rr/" target="#" className="flex-col w-full">
                      <div className="w-full bg-cover bg-no-repeat bg-center" style={{height: 100, backgroundImage: 'url(https://instagram.flis9-1.fna.fbcdn.net/v/t51.2885-15/fr/e15/s1080x1080/71304173_398561657763867_3930777215019056798_n.jpg?_nc_ht=instagram.flis9-1.fna.fbcdn.net&_nc_cat=103&_nc_ohc=V2sPZa9JmQAAX_Lmo3e&tp=1&oh=ecbe6e24eb0d74975e725fceaaf09f5b&oe=60460257)'}}>
                  ...
                  <div className="flex">
                    {/* Image*/}
                    <a href="https://www.instagram.com/ricardoribeiro.rr/" target="#" className="flex-col w-full mr-1">
                      <div className="w-full bg-cover bg-no-repeat bg-center" style={{height: 100, backgroundImage: 'url(https://instagram.flis9-1.fna.fbcdn.net/v/t51.2885-15/e35/28765942_569404996768567_810640940719931392_n.jpg?_nc_ht=instagram.flis9-1.fna.fbcdn.net&_nc_cat=107&_nc_ohc=Xf0LrzDMbp8AX8S55zD&tp=1&oh=0cf858806b52e56cc9093211b2656831&oe=6045F090)'}}>
                    ...
                    <a href="https://www.instagram.com/ricardoribeiro.rr/" target="#" className="flex-col w-full mr-1">
                      <div className="w-full bg-cover bg-no-repeat bg-center" style={{height: 100, backgroundImage: 'url(https://instagram.flis9-1.fna.fbcdn.net/v/t51.2885-15/e35/27877940_216827205533781_6550488685962330112_n.jpg?_nc_ht=instagram.flis9-1.fna.fbcdn.net&_nc_cat=109&_nc_ohc=ihm93wr5mUUAX_w6e1G&tp=1&oh=e492418bf694b130464f681f9fedd180&oe=60442B6C)'}}>
                    ...
                    <a href="https://www.instagram.com/ricardoribeiro.rr/" target="#" className="flex-col w-full">
                      <div className="w-full bg-cover bg-no-repeat bg-center" style={{height: 100, backgroundImage: 'url(https://instagram.flis9-1.fna.fbcdn.net/v/t51.2885-15/e35/22277804_1824335967579893_4558955485163683840_n.jpg?_nc_ht=instagram.flis9-1.fna.fbcdn.net&_nc_cat=105&_nc_ohc=CknMgBUYNhcAX-Jxi0P&tp=1&oh=631583468373481077e1834df4031435&oe=6045BD08)'}}>
